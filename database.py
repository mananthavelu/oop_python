...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        # For each neo in neos, build a dictionary mapping the designation
        # to its neo object
    ...
    def query(self, filters=()):
        ...
        isn't
        guaranteed to be sorted meaningfully, although is often sorted by
        time.
        ...
        if filters:
            # For each approach, ensure that the filters pass; and yield them
            for approach in self._approaches:
